...
export declare class rayClass {
    __debug__: boolean;
    constructor(debug: boolean);
    rayMake(origin: any, dir: any, len: any): TRay | TRay[];
    rayFromTo(xyz1: any, xyz2: any): TRay | TRay[];
    rayCopy(ray: any): TRay | TRay[];
    rayMove(ray: any, vec: any): TRay | TRay[];
    rayRot(ray1: any, ray2: any, ang: any): TRay | TRay[];
    rayLMove(ray: any, dist: any): TRay | TRay[];
    rayFromPln(pln: any): TRay | TRay[];
    rayLtoG(r: any, p: any): TRay | TRay[];
    rayGtoL(r: any, p: any): TRay | TRay[];
}
