...
export declare class mathClass {
    ...
    min(list: any): any;
    max(list: any): any;
    pow(base: any, xp: any): number | number[];
    sqrt(num: any): number | number[];
    exp(num: any): number | number[];
    log(base: any): number | number[];
    log10(base: any): number | number[];
    round(num: any, dec_pla?: number): number | number[];
    sigFig(num: any, sig_figs: any): number | number[];
    ceil(num: any): number | number[];
    floor(num: any): number | number[];
    abs(num: any): number | number[];
    sin(num: any): number | number[];
    asin(num: any): number | number[];
    sinh(num: any): number | number[];
    asinh(num: any): number | number[];
    cos(num: any): number | number[];
    acos(num: any): number | number[];
    cosh(num: any): number | number[];
    acosh(num: any): number | number[];
    tan(num: any): number | number[];
    atan(num: any): number | number[];
    atan2(xy: any): number | number[];
    tanh(num: any): number | number[];
    atanh(num: any): number | number[];
}
