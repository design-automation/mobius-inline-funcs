...
export declare class geometryClass {
    __debug__: boolean;
    constructor(debug: boolean);
    intersect(r1: any, r2: any, met: any): [number, number, number];
    project(c: any, r: any, met: any): [number, number, number];
    distance(c1: any, c2: any): number;
    distanceM(c1: any, c2: any): number;
    distanceMS(c1: any, c2: any): number;
}
export {};
