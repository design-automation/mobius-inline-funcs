...
export declare class listClass {
    __debug__: boolean;
    constructor(debug: boolean);
    range(start: any, end: any, step: any): number[];
    listCount(list: any, val: any): number;
    listCopy(list: any): any[];
    listRep(list: any, n: any): any[];
    listGet(list: any, idx: any): any;
    listFind(list: any, val: any): number;
    listHas(list: any, val: any): boolean;
    listJoin(list1: any, list2: any): any[];
    listFlat(list: any, depth: any): any[];
    listRot(list: any, rot: any): any[];
    listSlice(list: any, start: any, end: any): any[];
    listRev(list: any): any[];
    listCull(list1: any, list2: any): any[];
    listSort(list1: any, list2: any): any[];
    listZip(list1: any, list2: any): any[];
