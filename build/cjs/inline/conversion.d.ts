...
export declare class conversionClass {
    __debug__: boolean;
    constructor(debug: boolean);
    radToDeg(rad: any): number | number[];
    degToRad(deg: any): number | number[];
    numToStr(num: any, frac_digits?: any, locale?: any): string | string[];
    numToCurr(num: any, currency: any, locale?: any): string | string[];
}
