...
*/
export declare const RX: import("../libs/common").TRay;
/**
 * A ray with an origin `[0, 0, 0]` and a direction `[0, 1, 0]`.
 */
export declare const RY: import("../libs/common").TRay;
/**
 * A ray with an origin `[0, 0, 0]` and a direction `[0, 0, 1]`.
 */
export declare const RZ: import("../libs/common").TRay;
