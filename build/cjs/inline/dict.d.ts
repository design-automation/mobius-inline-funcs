...
export declare class dictClass {
    __debug__: boolean;
    constructor(debug: boolean);
    dictGet(dict: any, key: any): any;
    dictKeys(dict: any): string[];
    dictVals(dict: any): string[];
    dictHasKey(dict: any, key: any): boolean | boolean[];
    dictHasVal(dict: any, val: any): boolean;
    dictFind(dict: any, val: any): string;
    dictCopy(dict: any): object;
